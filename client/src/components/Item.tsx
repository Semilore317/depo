        ...
        <Box width={width}>
            ...
            >
                <Box
                    width="100%"
                    sx={{
                        aspectRatio: "3 / 4", // Enforce 3:4 aspect ratio (300px:400px)
                        overflow: "hidden",
                        borderRadius: "0.5rem",
                    }}
                >
                    <img
                        ...
                        style={{
                            width: "100%",
                            height: "100%",
                            objectFit: "cover", // Ensure images fill the container uniformly
                            cursor: "pointer",
                        }}
            ...
            <Box display="flex" flexDirection="column" justifyContent="space-between" marginTop="3px">
                {/* 
